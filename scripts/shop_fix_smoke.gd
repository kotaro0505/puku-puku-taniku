...
func _ready()->void:
	...
	game.formal_play_count=10;game.puku_points=6;game._open_shop_catalog_category();assert(game.arrangement_ui.visible and game.arrangement_ui.catalog_shop_page.visible and game.arrangement_ui.return_context=="shop" and game.arrangement_ui.catalog_shop_grid.get_child_count()==4)
	...
	game.arrangement_ui._request_catalog_purchase("metal");assert(bool(game.unlocked_series.get("metal",false)) and game.puku_points==3 and game.arrangement_ui.catalog_shop_grid.get_child_count()==4)
