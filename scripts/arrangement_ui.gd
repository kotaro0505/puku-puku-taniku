...
func _build_editor_page()->void:
	...
	add_plant_button=_button("＋ 多肉を追加",Vector2(154,687),Vector2(268,58),Color("#d7aa64"),20);add_plant_button.pressed.connect(_open_species_picker);editor_page.add_child(add_plant_button)
