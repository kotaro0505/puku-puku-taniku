...
func _ready()->void:
	...
	game.opening_story_complete=true;game._finish_opening();game.audio_manager.apply_settings({"bgm_enabled":false,"se_enabled":false});game.intro_story_complete=true;game.habitat_unlocked=true;game.habitat_tutorial_complete=true
