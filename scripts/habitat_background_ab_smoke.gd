...
func _ready()->void:
	...
	game.opening_story_complete=true;game._finish_opening();game.audio_manager.apply_settings({"bgm_enabled":false,"se_enabled":false});game.intro_story_complete=true;game.habitat_unlocked=true;game.habitat_awakened=true;game.habitat_awakening_event_complete=true;game.habitat_tutorial_complete=true
	game.discovered={"colorata":true};game.habitat_returned_species={"colorata":true,"affinis":true,"shaviana":true};game.pending_habitat_species.clear();game.habitat_mystery_seeds_pending=0
