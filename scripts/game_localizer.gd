...
const TEXT := {
	"ja": {
		...
		"old_seed_reaction_sprout": "芽が出た！",
		"old_seed_reaction_growth": "すごい、どんどん大きくなるよ！",
	...
	"hiragana": {
		...
		"old_seed_reaction_sprout": "めが でた！",
		"old_seed_reaction_growth": "すごい、どんどん おおきくなるよ！",
	...
	"en": {
		...
		"old_seed_reaction_sprout": "It sprouted!",
		"old_seed_reaction_growth": "Wow, it's getting bigger and bigger!",
