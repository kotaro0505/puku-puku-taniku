...
func _ready()->void:
	...
	game.puku_points=1;var purchased_bags_before:int=game.normal_seed_bags;game._buy_seed_bag("normal");assert(game.puku_points==1 and game.normal_seed_bags==purchased_bags_before and "石の光" in game.shop_message.text)
