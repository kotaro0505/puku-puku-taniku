...
func _save() -> void:
	...
	var payload:={
		...
		"habitat_wild_plants":habitat_wild_plants,"habitat_tutorial_started":habitat_tutorial_started,"habitat_tutorial_complete":habitat_tutorial_complete,
