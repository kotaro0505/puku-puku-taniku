...
func _show_shop_chatter(message:String,is_rescue:bool)->void:
	...
	if is_rescue:
		...
		shop_chatter_bubble.size=Vector2(bubble_width,bubble_height);shop_chatter_bubble.position=Vector2((576.0-bubble_width)*.5,276);_update_shop_chatter_tail()
...
func _update_shop_chatter_tail()->void:
	...
	var base_left:=Vector2(right-135.0,top+height-4.0);var base_right:=Vector2(right-65.0,top+height-4.0);var tip:=Vector2(right-145.0,top+height+10.0)
