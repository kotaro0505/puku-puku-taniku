...
func _show_shop_chatter(message:String,is_rescue:bool)->void:
	...
	if is_rescue:
		...
		shop_chatter_bubble.size=Vector2(bubble_width,bubble_height);shop_chatter_bubble.position=Vector2((576.0-bubble_width)*.5,340);_update_shop_chatter_tail()
...
func _update_shop_chatter_tail()->void:
	...
	var base_left:=Vector2(right-115.0,top+height-5.0);var base_right:=Vector2(right-55.0,top+height-5.0);var tip:=Vector2(right-125.0,top+height+22.0)
	shop_chatter_tail.polygon=PackedVector2Array([base_left,tip,base_right]);shop_chatter_tail_outline.points=PackedVector2Array([base_left,tip,base_right]);shop_chatter_tail.visible=true;shop_chatter_tail_outline.visible=true
