...
func _ready()->void:
	...
	game.catalog_species.append({"species_id":"future_image_probe","name_ja":"将来画像テスト","series_id":"future_preview","visual_variant":"not_in_sprite_table","image_path":"res://assets/catalog/gummy/gummy-soda.png","spawn_weight":0.0,"catalog_only":true})
	game._preview_catalog_species("future_image_probe")
	assert(game._catalog_preview_plants().size()==1)
	assert(game._catalog_preview_plants()[0].plant_sprite.texture.resource_path=="res://assets/catalog/gummy/gummy-soda.png")
