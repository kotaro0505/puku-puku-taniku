# ぷくぷく多肉 project instructions

- This repository is the standalone project for 「ぷくぷく多肉」.
- Work only inside `C:\puku-puku-taniku` for this project.
- Never read from, write to, or run Git commands against `C:\codex-test`.
- Never add a Git remote that points to the former `zucchini-lab` repository.
